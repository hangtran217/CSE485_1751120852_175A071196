<div class="head head-desktop">
			<div class="wrapper row top_head">
				<div class="col-md-3 hotline" style="padding-left: 100px;">
				...
				<div class="col-md-4 input d-flex justify-content-end" style="padding-right: 30px;">
					<form>
			...
			<div class="menu">
				...
				<div class="wrapper" >
					<nav class="navbar navbar-expand-lg">
					  	<img style="padding-right: 20px;" src="image/logo_ntt.png">
					  <button style="outline: none;" class="navbar-toggler" type="button" >
					    <i id="showCollapse2" style="border: 1px solid #d0d0d0;padding: 200px;" class="fa fa-bars c-blue-a5"></i>
					  </button>
